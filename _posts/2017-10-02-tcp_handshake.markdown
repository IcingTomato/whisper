...
说到 TCP 协议，相信大家都比较熟悉了，对于 TCP 协议总能说个一二三来，但是 TCP 协议又是一个非常复杂的协议，其中有不少细节点让人头疼点。本文就是来说说这些头疼点的，浅谈一些 TCP 的疑难杂症。那么从哪说起呢？当然是从三次握手和四次挥手说起啦，可能大家都知道 TCP 是三次交互完成连接的建立，四次交互来断开一个连接，那为什么是三次握手和四次挥手呢？反过来不行吗？<!--more-->

# 疑症（1）TCP 的三次握手、四次挥手

下面两图大家再熟悉不过了，TCP 的三次握手和四次挥手见下面左边的”TCP 建立连接”、”TCP 数据传送”、”TCP 断开连接”时序图和右边的”TCP 协议状态机” 。

![tcp](http://panzhifei.fun/img/post/2017/10/02/tcp.jpg)

![tcp_states](http://panzhifei.fun/img/post/2017/10/02/tcp_states.jpg)
...
![tcp2](http://panzhifei.fun/img/post/2017/10/02/tcp2.png)
...
![tcp3](http://panzhifei.fun/img/post/2017/10/02/tcp3.png)
...
![tcp4](http://panzhifei.fun/img/post/2017/10/02/tcp4.jpg)
...
![tcp5](http://panzhifei.fun/img/post/2017/10/02/tcp5.png)
...
![tcp6](http://panzhifei.fun/img/post/2017/10/02/tcp6.png)

下面两图演示的窗口的滑动情况，收到 36 的 ACK 后，窗口向后滑动 5 个 byte。

![tcp7](http://panzhifei.fun/img/post/2017/10/02/tcp7.png)

![tcp8](http://panzhifei.fun/img/post/2017/10/02/tcp8.png)

# 疑问 2）的解决

由问题 1）我们知道，发送端的发送窗口是由接收端控制的。下图，展示了一个发送端是怎么受接收端控制的。

![tcp9](http://panzhifei.fun/img/post/2017/10/02/tcp9.png)
...
![tcp10](http://panzhifei.fun/img/post/2017/10/02/tcp10.jpg)
...
![tcp11](http://panzhifei.fun/img/post/2017/10/02/tcp11.png)
